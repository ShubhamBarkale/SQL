...
UPDATE accounts SET status = 'Dormant' WHERE balance < 20000; DELETE FROM accounts WHERE account_id = 1005;
...
UPDATE accounts SET account_category = 'Regular' WHERE account_id = 1001;
UPDATE accounts SET account_category = 'Premium' WHERE account_id = 1002;
SELECT account_id, name, account_category FROM accounts;
